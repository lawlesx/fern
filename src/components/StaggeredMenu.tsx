        ...
        >
          ...
          >
            ...
            >
              ...
              >
                {textLines.map((l, i) => (
                  <span
                    className={twMerge(
                      "sm-toggle-line block h-[1em] leading-none",
                      open ? "text-black" : "text-[#e9e9ef]",
                    )}
                    key={i}
                  >
            ...
            <span
              ref={iconRef}
              className={twMerge(
                "sm-icon relative w-3.5 h-3.5 shrink-0 inline-flex items-center justify-center will-change-transform",
                open ? "text-black" : "text-[#e9e9ef]",
              )}
              aria-hidden="true"
            >
            ...
            >
              {items && items.length ? (
                items.map((it, idx) => (
                  ...
                  >
                    <Link
                      className="sm-panel-item relative text-black font-semibold text-[1rem] cursor-pointer leading-none tracking-[-2px] uppercase transition-[background,color] duration-150 ease-linear inline-block no-underline pr-[1.4em]"
                      href={it.link}
